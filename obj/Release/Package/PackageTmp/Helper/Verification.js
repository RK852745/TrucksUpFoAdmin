            ...
            },
            {
                render: function (data, type, row) {
                    ...
                    return "<div class='textdiv'>" + d + "</div><div class='textinput d-none'>" +
                        "<input style='border: 1px solid #ccc;border-radius: 5px; width:40px;' class='d-none smallsize textinput' value='" + (size[0] ? size[0].split('-')[0] : '') + "'/>&nbsp;" +
                        "<input style='border: 1px solid #ccc;border-radius: 5px;width:40px;' class='d-none mediumsize textinput' value='" + (size[1] ? size[1].split('-')[0] : '') + "'/>&nbsp;" +
                        "<input style='border: 1px solid #ccc;border-radius: 5px;width:40px;' class='d-none largesize textinput' value='" + (size[2] ? size[2].split('-')[0] : '') + "'/></div>";
                }
                ...
                //    // Check if smallsize, mediumsize, and largesize are defined
                //    var small = row.smallsize !== undefined ? row.smallsize : '0';
                //    var medium = row.mediumsize !== undefined ? row.mediumsize : '0';
                //    var large = row.largesize !== undefined ? row.largesize : '0';

                //    return "<div class='textdiv'>" + d + "</div><div class='textinput d-none'>" +
                //        "<input style='border: 1px solid #ccc;border-radius: 5px; width:40px;' class='d-none smallsize textinput' value='" + row.smallsize + "'/>&nbsp;" +
                //        "<input style='border: 1px solid #ccc;border-radius: 5px;width:40px;' class='d-none mediumsize textinput' value='" + row.mediumsize + "'/>&nbsp;" +
                //        "<input style='border: 1px solid #ccc;border-radius: 5px;width:40px;' class='d-none largesize textinput' value='" + row.largesize + "'/></div>";
                //}
                //render: function (data, type, row) {
