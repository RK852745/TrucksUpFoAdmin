...
function GetDatabydaterange(date, type) {
    ...
    var url = "/Reports/MethodGetFieldofficersStickerReports";
        ...
        $("#reportDatatable").DataTable(
            {
                ...
                columns: [
                    ...
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.todaystickervisit + "</div>";
                        }
                    },
                    //{
                    //    render: function (data, type, row) {
                    //        return "<div>" + row.todayappdownload + "</div>";
                    //    }
                    //},

                    {
                        render: function (data, type, row) {
                            return "<div>" + row.monthlystickervisit + "</div>";
                        }
                    },
                    //{
                    //    render: function (data, type, row) {
                    //        return "<div>" + row.monthlyappdownload + "</div>";
                    //    }
                    //},
                    //{
                    //    render: function (data, type, row) {
                    //        return "<div>" + row.totalappdownload + "</div>";
                    //    }
                    //},

                    {
                        render: function (data, type, row) {
                            return "<div>" + row.totalstickervisit + "</div>";
                        }
                    },
                    // {
                    //    render: function (data, type, row) {
                    //        return "<div>" + row.totalstickers + "</div>";
                    //    }
                    //},
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.smallcount + "</div>";
                        }
                    },
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.mediumcount + "</div>";
                        }
                    },
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.largecount + "</div>";
                        }
                    },
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.verifiedcount + "</div>";
                        }
                    },
                    {
                        render: function (data, type, row) {
                            return "<div>" + row.rejectedcount + "</div>";
                        }
                    },
                    {
                        render: function (data, type, row) {
